...
def remove_spaces(text):
    ...
    return user_text
    #This command removes any spaces/whitespace
...
def normalise_input(user_input):
    ...
    return user_text
    #Here punctuation and spaces are removed and the text is converted to lower case 
...
def display_room(room):
    ...
    print("\n" + room["name"].upper() + "\n\n" + room["description"] + "\n")
    #Here rooms name is displayed in uppercase and the description is displayed. All between blank lines
...
def exit_leads_to(exits, direction):
    ...
    #Here we look through a list/dictionary and display the name of each exit
...
def print_menu_line(direction, leads_to):
    ...
    #This command prints the possible exits
...
def print_menu(exits):
    ...
    print("You can:")
    for key in exits:
        print("Go" , key.upper() , "to" , exits[key])
    ...
    #This command gives you a list of options for directions and where they lead too
...
def is_valid_exit(exits, user_input):
    ...
    for exit in exits:
        if exit == user_input:
            return True
    return False
    #If the user input is a possible exit it will proceed
